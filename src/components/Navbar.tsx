...
export default function Navbar() {
  ...
  return (
    ...
    <nav
      ...
      style={{
        background: scrolled ? "rgba(10,27,51,0.92)" : "transparent",
      ...
      <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          <a href="/apartments"
            ...
            style={{ color: "rgba(247,249,252,0.78)" }}>
            דירות
          </a>
          <a href="/transfers"
            className="px-4 py-2 text-sm font-medium transition-colors hover:text-white"
        ...
        <div className="flex items-center gap-2.5">
          {isAdmin && (
            <a href="/admin"
              ...
              style={{ borderColor: "var(--ink-line-strong)", color: "var(--accent-light)" }}>
          ...
          {user ? (
            <a href="/my"
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-full border text-sm font-semibold transition-all hover:border-[var(--accent)]"
