          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="sticky top-20 bg-white rounded-2xl border border-gray-100 shadow-lg overflow-hidden">
              ...
              <div className="p-5 flex flex-col gap-3 text-sm">
                ...
                {/* El Al info box */}
                <div className="bg-blue-50 rounded-xl p-3 border border-blue-100 text-xs text-gray-600">
                  <p className="font-bold text-blue-700 mb-1">✈️ טיסות אל על ישיר</p>
                  <p>מספר טיסה שמתחיל ב-<span className="font-bold">LY</span> = מחיר קבוע €{PRICE_PER_DIRECTION}/אדם/כיוון</p>
                  <p className="mt-1 text-gray-400">חברות אחרות — המחיר משוער ויאושר לאחר ההזמנה</p>
                </div>
