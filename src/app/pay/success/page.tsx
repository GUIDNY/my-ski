...
export default function PaySuccess() {
  return (
    <div className="min-h-screen bg-[#f7f9fb] flex flex-col items-center justify-center text-center px-6" dir="rtl">
      ...
      <h1 className="font-display text-3xl font-black text-slate-900 mb-2">התשלום התקבל! 🎿</h1>
      <p className="text-slate-500 max-w-md mb-8">תודה! קיבלנו את התשלום. נציג SkiShare ייצור איתך קשר לאישור סופי של ההזמנה.</p>
