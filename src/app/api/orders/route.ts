...
export async function POST(req: NextRequest) {
  ...
  const row = {
    ...
    transfer_details: b.transfer_details || null,
    flight:         b.flight === true || b.flight === "true",
    flight_price:   b.flight_price != null ? Number(b.flight_price) : null,
    flight_details: b.flight_details || null,
    cancel:         b.cancel || "none",
    service:        b.service || "human",
    total_eur:      Number(b.grand_total ?? b.total_eur ?? 0),
    group_id:       b.group_id || null,
    share_amount:   b.share_amount != null ? Number(b.share_amount) : null,
    shares_total:   b.shares_total != null ? Number(b.shares_total) : null,
